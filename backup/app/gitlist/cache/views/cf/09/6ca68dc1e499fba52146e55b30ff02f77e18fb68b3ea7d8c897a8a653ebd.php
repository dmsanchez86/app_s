...
/* commits_list.twig */
class __TwigTemplate_cf096ca68dc1e499fba52146e55b30ff02f77e18fb68b3ea7d8c897a8a653ebd extends Twig_Template
{
        ...
        ";
            ...
            <td width=\"95%\">
                ...
                <span><a href=\"mailto:";
                    ...
                    echo "</a> authored on ";
                    if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
                    echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('format_date')->getCallable(), array($this->getAttribute($_item_, "date"))), "html", null, true);
                    echo "</span>
            </td>
        </tr>
        ";
