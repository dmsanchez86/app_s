...
/* commit.twig */
class __TwigTemplate_896caa41d7c1c1febda0e2c543e53faa4affe0747970a5ffade0589cbcd9d83b extends Twig_Template
{
    ...
    <div class=\"commit-view\">
        ...
        echo "</a> authored on ";
        if (isset($context["commit"])) { $_commit_ = $context["commit"]; } else { $_commit_ = null; }
        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('format_date')->getCallable(), array($this->getAttribute($_commit_, "date"))), "html", null, true);
        echo "<br />Showing ";
        if (isset($context["commit"])) { $_commit_ = $context["commit"]; } else { $_commit_ = null; }
